...
selected_stats = st.multiselect("Choisir statistiques pour le radar", options=stat_cols, default=st.session_state.get('players_stats', stat_cols[:5] if len(stat_cols)>5 else stat_cols), key='players_stats')
